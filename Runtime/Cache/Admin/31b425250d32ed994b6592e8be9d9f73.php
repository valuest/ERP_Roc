...
<script type="text/javascript" src="<?php echo ADMIN_JS_URL;?>jquery-1.6.min.js"></script>
...
<div class="nav-down">
	<div class="leftmenu1">
        <div class="menu-oc"><img src="<?php echo ADMIN_IMG_URL;?>menu-all.png" /></div>
    	<ul>
        	<li>
    ...
    <div class="leftmenu2">
    	<div class="menu-oc1"><img src="<?php echo ADMIN_IMG_URL;?>menu-all.png" /></div>
        <ul>
        	<li>
